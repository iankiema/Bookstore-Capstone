...
**Bookstore** website is an application used to provide the user with online books that they can access,comment and like.
...
```sh
  cd my-folder
  git clone https://github.com/iankiema/Bookstore-Capstone.git
```
...
- [ ] **Adding access to read the book online**
...
We would like to thank Microverse for the overwhelming support for giving us an overview in this project.
